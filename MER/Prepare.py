...
def mix_prepare():
    ...
    File_save_dir = '/home/user/Yuchi/iccv2019/MER/Loading_file'
...
# # =========================================================================================
    ...
    for _, row in samm_data.iterrows():
        ...
        bbs = cropped_face(pic_apex_path, save_apex_pic_path)
        cropped_face(bbs, pic_onset_path, save_onset_pic_path)
...
# =================================================================================================
    ...
    for index, (_, row) in enumerate(SMIC_data.iterrows()):
        ...
        bbs = cropped_face(onset_path, onset_save_path)
        cropped_face_rest(bbs, apex_path, apex_save_path)
...
# ===================================================================================================
    ...
    for index, row in CASMEII_data.iterrows():
        ...
        bbs = cropped_face(CASMEII_onset_path, CASMEII_onset_save_path)
        cropped_face_rest(bbs, CASMEII_apex_path, CASMEII_apex_save_path)
