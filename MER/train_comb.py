...
from Utils.Dataloader_GAN import GAN_loader
...
def train(train_dataloader, model, criterion, optimizer, epoch, print_freq=100):
    for i in range(2):
    ...
    for i, sample in enumerate(train_dataloader):
        ...
        # nn.utils.clip_grad_norm_(model['fc'][0].parameters(), Clip_Norm, norm_type=2)
        # nn.utils.clip_grad_norm_(model['fc'][1].parameters(), Clip_Norm, norm_type=2)
...
def main():
    ...
    parser.add_argument('--train_data_path_1', type=str, help='path to training data')
    parser.add_argument('--train_label_path_1', type=str, help='path to training labels')
    parser.add_argument('--train_data_path_2', type=str, help='path to training data')
    parser.add_argument('--train_label_path_2', type=str, help='path to training labels')
    parser.add_argument('--validation_data_path', type=str, help='path to test data')
    parser.add_argument('--validation_label_path', type=str, help='path to test labels')
    ...
    train_dataset = GAN_loader(args, args.train_data_path_1, args, args.train_data_path_2, args.train_label_path, transform=transform)
    validation_dataset = GAN_loader(args, args.validation_data_path_1, args.validation_data_path_2, args.validation_label_path, transform=transform,
                                    Micro_set=True)
    ...
    for epoch in range(args.nepochs_no_decay + args.nepochs_decay):
        ...
        f1_score = validate(validation_loader, model, criterion)
