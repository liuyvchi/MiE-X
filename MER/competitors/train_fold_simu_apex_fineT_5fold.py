...
def build_model_2pic(num_classes=3):
    model = GAN_npic(fc=[512 * 2, 128, 32, 5])
...
def main():
    ...
    parser.add_argument('--Loading_path_f', type=str,
                        default="/home/yuchi/micro-expression/MER/Loading_file_new/MMEW_5fold/",
    ...
    for i in range(5):
        ...
        model['resnet'].load_state_dict(
            torch.load('/home/yuchi/micro-expression/MER/competitors/log/flo/fold0_encoder.pt'))
    ...
    for epoch in range(args.nepochs_no_decay + args.nepochs_decay + args.nepoches_fineT):
        ...
        for fold_num in range(fold_total):
            if epoch < args.nepochs_no_decay + args.nepochs_decay:
                ...
                #            "log/flo/fold" + str(fold_num) + "_encoder_apex.pt")
                # torch.save(models[fold_num]['classifier'].state_dict(),
                #            "log/flo/fold" + str(fold_num) + "_classifier_apex.pt")
            else:
                print('fold number', fold_num, "===============================================")
