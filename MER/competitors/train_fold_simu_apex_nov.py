...
# from models import model_npic, one_pic
    ...
    for epoch in range(args.nepochs_no_decay + args.nepochs_decay):
        ...
        for fold_num in range(3):
            ...
            if f1_score_test >= best_f1s[fold_num]:
                ...
                torch.save(models[fold_num]['resnet'].state_dict(), "apex_checkpoint/fold" + str(fold_num) + "_encoder0.pt")
                torch.save(models[fold_num]['classifier'].state_dict(), "apex_checkpoint/fold" + str(fold_num) + "_classifier.pt")
