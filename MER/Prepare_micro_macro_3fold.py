...
def mix_prepare():
    ...
    File_save_dir = '/home/user/Yuchi/iccv2019/MER/Loading_file/macro_micro_3fold'
    ...
    for fold_num in range(len(folds)):
        ...
        for data_index in range(len(data_list)):
            ...
            for index, row in samm_data.iterrows():
                ...
                if not os.path.exists(save_onset_pic_path):
        ...
        # =================================================================================================
            ...
            for index, (_, row) in enumerate(SMIC_data.iterrows()):
                ...
                if not os.path.exists(onset_save_path):
        ...
        # ===================================================================================================
            ...
            for index, row in CASMEII_data.iterrows():
                ...
                if not os.path.exists(CASMEII_onset_save_path):
                    ...
                    for test in os.listdir(subject_label_path):
                        ...
                        if os.listdir(test_label_path):
                            ...
                            if label != 0:
                                ...
                                bb = cropped_face(CK_onset_path, CK_onset_save_path)
                                cropped_face_rest(bb, CK_apex_path, CK_apex_save_path)
                                ...
                                with open (DATA_FILE, 'a') as d:
                                    d.write(CK_onset_save_path + '\n')
                                    d.write(CK_apex_save_path + '\n')
