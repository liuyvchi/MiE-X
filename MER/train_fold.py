...
def main():
    ...
    for i in range(3):
        models[i]['resnet'][0].load_state_dict(torch.load("checkpoint/fold" + str(i) + "_encoder0.pt"))
        models[i]['resnet'][1].load_state_dict(torch.load("checkpoint/fold" + str(i) + "_encoder1.pt"))
        models[i]['discriminator'].load_state_dict(torch.load("checkpoint/fold" + str(i) + "_classifier.pt"))
    ###############################
